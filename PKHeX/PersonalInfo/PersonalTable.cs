...
namespace PKHeX
{
    ...
    {
        internal static readonly PersonalTable SM = new PersonalTable(Mass_Editor.Properties.Resources.personal_sm, GameVersion.SM);
        internal static readonly PersonalTable AO = new PersonalTable(Mass_Editor.Properties.Resources.personal_ao, GameVersion.ORAS);
        internal static readonly PersonalTable XY = new PersonalTable(Mass_Editor.Properties.Resources.personal_xy, GameVersion.XY);
        internal static readonly PersonalTable B2W2 = new PersonalTable(Mass_Editor.Properties.Resources.personal_b2w2, GameVersion.B2W2);
        internal static readonly PersonalTable BW = new PersonalTable(Mass_Editor.Properties.Resources.personal_bw, GameVersion.BW);
        internal static readonly PersonalTable HGSS = new PersonalTable(Mass_Editor.Properties.Resources.personal_hgss, GameVersion.HGSS);
        internal static readonly PersonalTable Pt = new PersonalTable(Mass_Editor.Properties.Resources.personal_pt, GameVersion.Pt);
        internal static readonly PersonalTable DP = new PersonalTable(Mass_Editor.Properties.Resources.personal_dp, GameVersion.DP);
        internal static readonly PersonalTable LG = new PersonalTable(Mass_Editor.Properties.Resources.personal_lg, GameVersion.LG);
        internal static readonly PersonalTable FR = new PersonalTable(Mass_Editor.Properties.Resources.personal_fr, GameVersion.FR);
        internal static readonly PersonalTable E = new PersonalTable(Mass_Editor.Properties.Resources.personal_e, GameVersion.E);
        internal static readonly PersonalTable RS = new PersonalTable(Mass_Editor.Properties.Resources.personal_rs, GameVersion.RS);
        internal static readonly PersonalTable C = new PersonalTable(Mass_Editor.Properties.Resources.personal_c, GameVersion.C);
        internal static readonly PersonalTable GS = new PersonalTable(Mass_Editor.Properties.Resources.personal_c, GameVersion.GS);
        internal static readonly PersonalTable RBY = new PersonalTable(Mass_Editor.Properties.Resources.personal_rby, GameVersion.RBY);
