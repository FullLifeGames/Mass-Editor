...
namespace Mass_Editor
{
    public partial class SAV_HallOfFame : Form
    {
        ...
        private void UpdateImage(int species, int form, int item, int gender, bool shiny)
        {
            ...
            {   // Is Shiny
                // Redraw our image
                baseImage = Mass_Editor.Util.LayerImage(baseImage, Properties.Resources.rare_icon, 0, 0, 0.7);
            }
            if (item > 0)
            {
                // Has Item
                ...
                // Redraw
                baseImage = Mass_Editor.Util.LayerImage(baseImage, itemimg, 22 + (15 - itemimg.Width) / 2, 15 + (15 - itemimg.Height), 1);
            }
