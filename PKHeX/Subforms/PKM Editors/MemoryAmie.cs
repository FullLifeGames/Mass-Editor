        ...
        public void MemoryAmie_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (amienabled != null && amiindex != null)
                {
                    ...
                    if (amienabled[17]) CB_Region0.SelectedIndex = amiindex[17];
                    if (amienabled[18]) CB_Region1.SelectedIndex = amiindex[18];
                    if (amienabled[19]) CB_Region2.SelectedIndex = amiindex[19];
                    if (amienabled[20]) CB_Region3.SelectedIndex = amiindex[20];
                    if (amienabled[21]) CB_Region4.SelectedIndex = amiindex[21];
